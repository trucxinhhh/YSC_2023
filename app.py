...
mo_hinh = load_model("U:/THI/YSC_2023/25_10_2023/Model/19_11_2023/train_11")
# mo_hinh = load_model("U:/THI/YSC_2023/25_10_2023/Model/23_11_2023/train_1")
...
def control_signal(data1):
    ...
    elif  data > 1.98 and data <= 2.1: 
        print("TRAI ")
        print(data)
        # send_data(-150,150)
    # elif  data > 2.99 and data <= 3.0001: 
    #     print("phai")
    #     print(data)
    #     send_data(150,-150)
    else :
...
def AI_control(data):
    ...
    check_data.append(Num.copy())
    print(check_data)
    check_data2=check_data.copy()
    if len(check_data) > 5:
        check_data.pop(0)
        check_data2.sort()
        control_signal(check_data2[-3][0])
        Num_list.append(check_data2[-3][0])
  
    else:
        Num_final=Num[0]
        control_signal(Num_final)
        Num_list.append(Num_final)
    df1['lable']=Num_list

    df1.to_csv("U:/THI/YSC_2023/25_10_2023/data_28_11/data0.csv")
